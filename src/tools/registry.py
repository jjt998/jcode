...
def build_default_registry() -> ToolRegistry:
    ...
    registry.register(Tool("apply_patch", ApplyPatchArgs, apply_text_patch, read_only=False, risky=True, description="Replace one exact text span in an existing workspace file. old_text/new_text are strings; content and whitespace must come verbatim from the latest read_file result, while LF/CRLF line endings may be transport-normalized."))
